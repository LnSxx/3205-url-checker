...
JobsProcessor
  ...
  -> запускает до 5 проверок URL-адресов одновременно для каждого задания
...
Отменяет задание. Уже обработанные проверки URL-адресов остаются сохраненными. Ожидающие проверки URL-адресов помечаются как отмененные. Активные запросы прерываются, если еще не отданы на исполнение.
